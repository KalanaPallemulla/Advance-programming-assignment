...
public class BranchController {
    ...
    @PutMapping("/branch/{branchId}/booking/{bookingId}")
    Branch createNewBooking(@PathVariable Long branchId, @PathVariable Long bookingId) {
        return branchService.createNewBooking(branchId, bookingId);
    }
}
